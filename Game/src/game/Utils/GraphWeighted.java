...
public class GraphWeighted {
    ...
    public ArrayList<GameObject> DijkstraShortestPath(NodeWeighted start, NodeWeighted end) {
        ...
        while (true) {
            ...
            if (currentNode == end) {
                ...
                while (true) {
                    ...
                    path.add(parent.getGmObj());
                    child = parent;
                }
                //path.forEach(this::print); // to visualize the path in console
    ...
    private void print(GameObject go){
